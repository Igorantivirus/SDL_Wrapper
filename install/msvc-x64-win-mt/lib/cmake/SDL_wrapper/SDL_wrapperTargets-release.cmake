...
# Import target "SDL_wrapper::audio" for configuration "Release"
set_property(TARGET SDL_wrapper::audio APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(SDL_wrapper::audio PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/SDL_wrapper-audio.lib"
  )

list(APPEND _cmake_import_check_targets SDL_wrapper::audio )
list(APPEND _cmake_import_check_files_for_SDL_wrapper::audio "${_IMPORT_PREFIX}/lib/SDL_wrapper-audio.lib" )
